...
class CrackGreetest():
    ...
    def get_unFull_image(self,name):
        ...
        unfull_captcha = element.screenshot(name)
    ...
    def get_full_image(self,name):
        ...
        full_captcha = element.screenshot(name)
    ...
    def crack(self):
        try:
            ...
            # 获取验证码图片
            unfull_path = r'/Users/user/Pictures/unfull_captcha.png'
            self.get_unFull_image(unfull_path)
            image1 = Image.open(unfull_path)

            # 获取带缺口的验证码图片
            full_path = r'/Users/user/Pictures/full_captcha.png'
